...
class _PendingForumsScreenState extends State<PendingForumsScreen> {
  ...
  final Set<int> _approvingQueueIds = <int>{};
  ...
  Future<void> _approveForum(PendingForumApproval forum) async {
    ...
    setState(() => _approvingQueueIds.add(forum.queueId));
    try {
      ...
      if (mounted) {
        setState(() => _approvingQueueIds.remove(forum.queueId));
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context)!;
    final hasAdminAccess = AuthState.instance.currentUser?.hasAdminAccess == true;
                      ...
                      child: _forums.isEmpty
                          ...
                          : ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final isApproving = _approvingQueueIds.contains(forum.queueId);
                                return Center(
                                          ...
                                          children: [
                                            ...
                                            Align(
                                              ...
                                              child: FilledButton.icon(
                                                onPressed: isApproving ? null : () => _approveForum(forum),
                                                icon: isApproving
                                                    ? const SizedBox(
                                                        width: 18,
                                                        height: 18,
